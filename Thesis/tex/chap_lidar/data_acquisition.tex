...
\begin{table}[h]
    ...
    \begin{tabular}{@{}lllllrr@{}}
        \toprule
        \makecell[lc]{\textbf{Beginning} \\ \textbf{time}} & \makecell[lc]{\textbf{Duration} \\ (HH:MM)} & \makecell[lc]{\textbf{Snowflakes} \\ \textbf{size}} & \makecell[lc]{\textbf{Falling} \\ \textbf{rate}} & \makecell[lc]{\textbf{Wind speed} \\ \textbf{range} \\ (\SI{}{\km\per\hour})} & \makecell[rc]{\textbf{Daily pre-} \\ \textbf{cipitation} \\ (\SI{}{\cm})}  & \makecell[rc]{\textbf{Temperature} \\ (\SI{}{\celsius})} \\
        \hline
