...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{The set of NARF parameters used for the \gls*{bow} preprocessing and the correspondences scoring. The support size radius around the keypoint used in the \gls*{3d} space used to compute the descriptor. Note that it is represented by a proportion of the average range of all points in the database.}
