...
\begin{algorithm}
    \begin{algorithmic}[1]
        ...
        \Statex
        \Function{findPotentialMatches}{$x, y$}
...
%\begin{algorithm}[H]
%\KwIn{MyInput}
%\KwOut{An ordered list of potential matches with the score}
%\SetKwFunction{KwFn}{Fn}{}{}
%\KwFn{test}{The code}
%\textbf{findPotentialMatches}(scansDatabase, scan)
...
%}
%}
%\Return{OrderedListOfPotentialMatches}
%\caption{High Level Place Recognition Process}
%\label{alg:chap_slam_overview}
%\end{algorithm}
%\DecMargin{1em}
